...
def make_datapath_list(phase="train", rate=0.8):
    ...
    for name in files_name:
        ...
        #srd
        #path_C.append(rootpath + phase + '_C/'+name.replace('.jpg', '_no_shadow.jpg'))
    ...
    if phase=='train':
        ...
        # for test
        # path_A, path_A_val = path_A[:20], path_A[int(num * rate):]
        # path_B, path_B_val = path_B[:20], path_B[int(num * rate):]
        # path_C, path_C_val = path_C[:20], path_C[int(num * rate):]
